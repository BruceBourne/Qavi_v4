...
def inject_styles():
    ...
    h1,h2,h3{font-family:'Palatino Linotype','Palatino','Book Antiqua','URW Palladio L',Georgia,serif!important;font-style:italic;letter-spacing:.02em;}
    ...
    .card-title{font-family:'Palatino Linotype','Palatino','Book Antiqua','URW Palladio L',Georgia,serif;font-style:italic;font-size:1rem;letter-spacing:.02em;color:var(--text);margin:0 0 .3rem 0;}
    .card-sub{font-size:.8rem;color:var(--text2);margin:0;line-height:1.5;}

    .page-title{font-family:'Palatino Linotype','Palatino','Book Antiqua','URW Palladio L',Georgia,serif;font-style:italic;font-size:1.7rem;letter-spacing:.02em;color:var(--text);margin-bottom:.15rem;}
