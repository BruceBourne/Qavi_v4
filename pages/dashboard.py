...
def render():
    ...
    if role in ("advisor","owner"):
        ...
        if b6.button("📄 Report",   use_container_width=True): navigate("report")
        if role == "owner":
            if st.button("👑 Owner Dashboard", use_container_width=True): navigate("owner")
    ...
    # ── CLIENT ────────────────────────────────────────────────────────────
        ...
        if b4.button("📄 Report",        use_container_width=True): navigate("report")
